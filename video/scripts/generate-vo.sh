...
gen "vo-11-agents-3" "Full Agent Wallet integration. Sole stakes."
...
gen "vo-15-build-2" "One agent. Full stack. No human code."
gen "vo-16-build-3" "Content Bible, custom audio, Solana integration."
