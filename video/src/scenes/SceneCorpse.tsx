...
const VO_LINES = [
  { text: "When you die, you become part of the world.", start: 0.5, end: 3 },
  { text: "Other players find your corpse.", start: 3.5, end: 5.4 },
  { text: "They can loot you, or pay respects with SOL.", start: 6, end: 8.5 },
];
