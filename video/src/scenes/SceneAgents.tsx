...
const VO_LINES = [
  { text: "But here's where it gets interesting.", start: 0.5, end: 2.2 },
  { text: "Agents can play too.", start: 3, end: 4.4 },
  { text: "They read a skill file. Learn the API. Make decisions.", start: 5, end: 8.3 },
  { text: "Full AgentWallet integration. With SOL stakes.", start: 9, end: 12 },
];
...
export const SceneAgents: React.FC = () => {
  ...
  // Phase 1: 0-5s - Intro (vo-10, vo-11)
  // Phase 2: 5-9s - Skill file (vo-12)
  // Phase 3: 9-16s - AgentWallet code (vo-13)

  const phase = frame < 5 * fps ? 1 : frame < 9 * fps ? 2 : 3;
        ...
        <div style={{ ...centerFlex, width: "100%", padding: "0 40px" }}>
          ...
          >
            {skillLines.map((line, i) => {
              ...
              const displayLine = typewriter(localFrame, fps, line, 60, delay);
        ...
        <div style={{ ...centerFlex, width: "100%", padding: "0 40px" }}>
          <div
            style={{
              ...
              fontWeight: "bold",
              marginBottom: 30,
              ...slideUp(frame - 9 * fps, fps, 0),
            }}
          >
            💰 AgentWallet — SOL stakes
          </div>
          <div
            style={{
              ...terminalBox,
              width: "85%",
              ...slideUp(frame - 9 * fps, fps, 0.3),
            }}
          >
