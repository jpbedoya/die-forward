...
const VO_LINES = [
  { text: "Stake SOL. Descend into the crypt.", start: 0.5, end: 2.7 },
  { text: "Fight creatures. Probably die.", start: 3.5, end: 5.5 },
  { text: "Every death is hashed and verified on Solana.", start: 6.5, end: 9 },
];
