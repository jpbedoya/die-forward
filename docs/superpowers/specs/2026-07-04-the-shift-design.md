...
2. **Architect corpse-wall UGC (names/final words) and Echo Husk phrases** are explicitly out of scope for 4a — both require player-authored text on a shared surface and wait for phase 4b behind the A2 moderation gate; no UGC is written into `worldShifts`.
