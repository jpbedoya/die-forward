  ...
  return (
    <div className="text-xs py-2 border-b border-[var(--border-dim)] opacity-70 hover:opacity-100 transition-opacity">
      <div className="flex items-center gap-2 mb-1">
        ...
        <span className="text-[var(--text-muted)]">fell in {zone} (room {room})</span>
...
{ASCII_LOGO}
        ...
        <div className="flex items-center gap-6 text-xs text-[var(--text-muted)] mb-8">
          <div>
            <span className="text-[var(--red)]">☠</span> 1,247 deaths today
          </div>
          <div>
            <span className="text-[var(--amber)]">◎</span> 42.5 SOL in pools
          </div>
          <div>
      ...
      {/* Death feed */}
      <div className="border-t border-[var(--border-dim)] px-4 py-3 max-h-48 overflow-y-auto">
        <div className="text-[var(--text-dim)] text-xs mb-2 uppercase tracking-wider">
          ◈ Live Death Feed
        </div>
