            ...
            >
              <View className="flex-row items-center gap-3">
                ...
                {asset ? (
                  <Image
                    source={asset}
                    style={{ width: 56, aspectRatio: 341/512, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(180,30,30,0.35)' }}
                    resizeMode="cover"
                  />
                ) : (
                  <View style={{ width: 56, aspectRatio: 341/512, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(180,30,30,0.35)', alignItems: 'center', justifyContent: 'center' }}>
